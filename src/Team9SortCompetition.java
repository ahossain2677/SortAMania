...
public class Team9SortCompetition {
	...
	public static void bubbleSort(String[] arr) {	//Bubble Sort for Challenge two
	...
	public static void swapString(String [] arr, String i, String j)  // swap for challenge 2 bubble sort
    {
        String temp = arr[i];
        arr[i] = arr[j];
        arr[j] = temp;
